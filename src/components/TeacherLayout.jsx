...
const teacherMenuItems = [
  ...
  { label: 'Schedule', to: '/teacher/schedule', icon: '📅' },
  { label: 'Lesson History', to: '/teacher/history', icon: '📚' },
  { label: 'Earnings', to: '/teacher/earnings', icon: '💰' },
  { label: 'Reviews', to: '/teacher/reviews', icon: '⭐' },
  { label: 'Messages', to: '/teacher/messages', icon: '💬' },
  { label: 'Account', to: '/teacher/account', icon: '👤' },
]
      ...
      <aside style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ fontSize: '16px', fontWeight: 700, color: '#0F172A', margin: 0 }}>Teacher</p>
          </div>
          {isMobile && (
          ...
          <div style={{ position: 'relative' }}>
            ...
            {profileOpen && (
              <div style={{
                ...
                <button onClick={() => navigate('/teacher/account')} style={{
