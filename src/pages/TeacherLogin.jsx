...
function TeacherLogin() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden px-4 py-8 sm:px-6 lg:px-8">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(56,189,248,0.2),transparent_40%),radial-gradient(circle_at_bottom_left,rgba(14,165,233,0.16),transparent_45%)]" />
        ...
        <div className="grid w-full items-stretch gap-6 lg:grid-cols-[1fr_430px]">
          <Card className="hidden border-slate-200 bg-white shadow-soft lg:block">
            <CardContent className="flex h-full flex-col justify-between p-8">
              ...
              <div className="space-y-3 text-sm text-slate-600">
                <p>1. Handle sudden lesson requests in real time</p>
                <p>2. Control schedule and reservations</p>
                <p>3. Review completed lesson history</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-slate-200 bg-white text-slate-900 shadow-soft">
            <CardHeader className="space-y-2">
              ...
              <CardDescription>Sign in to your teaching workspace.</CardDescription>
            </CardHeader>
            <CardContent>
