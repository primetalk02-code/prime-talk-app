  ...
  useEffect(() => {
    ...
    const init = async () => {
      try {
        ...
        if (teacher) {
          connectVideo(roomUrl, lessonData.teacher_token)
        } else {
        ...
        {!joined && (status || error) && (
          <div style={{
            ...
            {error ? (
              ...
              <p style={{ color: '#EF4444', fontSize: '15px', textAlign: 'center', maxWidth: '360px', margin: 0 }}>
                {error}
              </p>
              ...
              {status.includes('Waiting') && (
                <p style={{ color: '#475569', fontSize: '13px', margin: 0 }}>
                  Stay on this page — you will join automatically when the teacher accepts
                </p>
              )}
              <div style={{
